...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    reset: function reset() {
      // プレビューを消す
      this.preview = ''; // inputデータを消す this.$el.querySelectorはコンポーネントそのもののDOMを探すためのもの

      this.$el.querySelector('input[type="file"]').value = null; // 保持していた画像データの情報を消す
    ...
    onFileChange: function onFileChange(event) {
      ...
      reader.readAsDataURL(event.target.files[0]); // 選択された画像をthis.photoとして保持
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                // ロード画面を表示
                _this2.loading = true; // HTML5のFormDataAPIを使ってAjaxでファイル送信を行う

                formData = new FormData(); // onFileChangeで保持したデータを代入

                formData.append('photo', _this2.photo); // APIを叩く
              ...
              case 5:
                ...
                _this2.loading = false; // バリデーションエラーの場合はreturn falseで処理自体を中断
...
/* harmony import */ var _components_Photo_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/Photo.vue */ "./resources/js/components/Photo.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    Photo: _components_Photo_vue__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  data: function data() {
    return {
      photos: []
    ...
    [
      _c("figure", { staticClass: "photo__wrapper" }, [
        _c("img", {
          ...
          attrs: { src: _vm.item.url, alt: "Photo by ${item.owner.name}" }
        })
      ]),
      _vm._v(" "),
      _c(
...
window.axios.interceptors.response.use( // 第一引数には成功時の処理
function (response) {
  return response;
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              context.commit('setApiStatus', null); // logoutにユーザー情報は比喩等ないので引数にdataは必要ない
            ...
            case 3:
              ...
              context.commit('setApiStatus', true); // setUserをnullにすることでユーザー情報を未ログイン状態に戻す
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              context.commit('setApiStatus', null); // userAPIを叩いてユーザー情報の取得
            ...
            case 3:
              ...
              context.commit('setApiStatus', true); // setUserを呼び出し、stateの書き換え
